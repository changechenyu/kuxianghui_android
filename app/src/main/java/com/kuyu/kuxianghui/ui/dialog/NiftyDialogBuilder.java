...
import com.kuyu.kuxianghui.ui.dialog.effect.BaseEffects;
...
public class NiftyDialogBuilder extends Dialog implements DialogInterface {
    ...
    private final String defDialogColor="#FFF96F00";   //#FFE74C3C
    ...
    public NiftyDialogBuilder withTitle(int textResId) {
        ...
        String title=tmpContext.getString(textResId);
        mTitle.setText(title);
        return this;
    }
     ...
     * @return
     */
    public NiftyDialogBuilder withPPMaoDef() {
    	//Title
    	toggleView(mLinearLayoutTopView,R.string.dialog_cart_title);
        String title=tmpContext.getString(R.string.dialog_cart_title);
        mTitle.setText(title);
        //Icon
        mIcon.setImageDrawable(tmpContext.getResources().getDrawable(R.mipmap.icon_logo_tips));
        //Dialog color
        mLinearLayoutView.getBackground().setColorFilter(ColorUtils.getColorFilter(Color.parseColor(defDialogColor)));
        return this;
    }
    ...
    public NiftyDialogBuilder withButton1Text(int resid) {
        mButton1.setVisibility(View.VISIBLE);
        mButton1.setText(tmpContext.getString(resid));
        return this;
    }
    ...
    public NiftyDialogBuilder withButton2Text(int resid) {
        mButton2.setVisibility(View.VISIBLE);
        mButton2.setText(tmpContext.getString(resid));
        return this;
    }

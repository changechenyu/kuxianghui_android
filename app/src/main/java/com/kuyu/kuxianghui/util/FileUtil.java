...
public class FileUtil {
	...
	public static long getFileLogSizes(File f) throws Exception {
		long s = 0;
		if (f.exists()) {
...
//	public static Long getFileFloderSize(File file) throws Exception {  
//		Long fileSizes = 0l;
//        if(file.isFile()){  
...
//    }  
	...
	public static void deleteFilesByDirectory(File directory) {
		Log.d("fish", "directory:"+directory.getPath());
        if (directory != null && directory.exists() && directory.isDirectory()) {
            for (File item : directory.listFiles()) {
            	Log.d("fish", "File:"+item.getName());
                item.delete();
            }
